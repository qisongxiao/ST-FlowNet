...
The datasets of **ST-FlowNet: A lightweight framework for long-term spatio-temporal flow field prediction**  
Authors: Qisong Xiao, Xinhai Chen, Haijian Yang, Chunye Gong, Jie Liu


📌 [Download](https://drive.google.com/drive/folders/1kgk_9eF9kqCGtYCPKklgTa_1W7z1zR8S?usp=drive_link)
...
### Single-condition Kolmogorov Dataset
- **kolmogorov_re_1000_samples_1500.npz**: Two-dimensional Kolmogorov flow, with 1500 time steps and Reynolds number 1000. The simulation is performed using the pseudo-spectral method with periodic boundary conditions. The spatial resolution is 128×128, and the physical domain spans $x, y \in (0, 2\pi)$.
...
```bibtex
@article{xiao2025st,
  title={ST-FlowNet: A lightweight framework for long-term spatio-temporal flow field prediction},
  author={Xiao, Qisong and Chen, Xinhai and Yang, Haijian and Gong, Chunye and Liu, Jie},
